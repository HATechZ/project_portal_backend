...
system_admin, division_lead, and contextual Team Lead create scope plus Member rules;
...
system_admin, actor Member Division for division_lead, and exact led Team Division for contextual
Team Lead. Update resolves the Division under the existing update authority. The existing
...
isolation, scoped system_admin/division_lead/contextual-Team-Lead create cases, and denied
