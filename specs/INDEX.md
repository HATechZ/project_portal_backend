...
| **01.1** | **Schema Integrity & Tenant Isolation** — RLS + privileged relay role, composite tenant-carrying FKs, identity split, derived-column removal, lookup collapse | — (reshapes 52) | **Phase 3** | 0/42 | `[SPEC APPROVED]` | Sibling of 01. **Must land before 06** — every move is one migration today and a migration plus nine module rewrites after. Phases 6–12 blocked on the deleted DBML (01's deviation); Phase 9 also on an owner answer. Phase 5 is unblocked. |
