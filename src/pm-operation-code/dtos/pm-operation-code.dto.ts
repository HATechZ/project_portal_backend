...
export class PmOperationDocumentCodeInputDto {
...
export class UpdatePmOperationDocumentCodeDto {
...
export class PmOperationDocumentCodeQueryDto {
  @ApiPropertyOptional({
...
export class PmOperationDocumentCodeResponseDto {
