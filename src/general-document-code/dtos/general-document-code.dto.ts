...
export class GeneralDocumentCodeInputDto {
...
export class UpdateGeneralDocumentCodeDto {
...
export class GeneralDocumentCodeQueryDto {
  @ApiPropertyOptional({
...
export class GeneralDocumentCodeResponseDto {
