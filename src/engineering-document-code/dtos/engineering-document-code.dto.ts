...
export class EngineeringDocumentCodeInputDto {
...
export class UpdateEngineeringDocumentCodeDto {
...
export class EngineeringDocumentCodeQueryDto {
  @ApiPropertyOptional({
...
export class EngineeringDocumentCodeResponseDto {
