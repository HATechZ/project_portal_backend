...
export class MarketingDocumentCodeInputDto {
...
export class UpdateMarketingDocumentCodeDto {
...
export class MarketingDocumentCodeQueryDto {
  @ApiPropertyOptional({
...
export class MarketingDocumentCodeResponseDto {
